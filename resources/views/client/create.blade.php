            ...
            <div class="col-xl-12">
                ...
                @csrf    
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name= "first" required maxlength="50">
                    </div>
                    <div class="form-group">
                        <label for="last">Last Name</label>
                        <input type="text" class="form-control" name= "last" required maxlength="50">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name= "phone" required maxlength="15">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name= "hobby" required maxlength="50">
                    </div>
                    <div class="form-group">
